...
Reference formats:
  myproject#123          Project alias + number
  owner/repo#123        Full GitHub reference
  https://...           GitHub URL
  #123                  Number only (uses current repo)

Examples:
  psm review myproject#123
  psm fix Yeachan-Heo/#42
  psm feature myprojectadd-webhooks
  psm list
  psm attach myproject:pr-123
  psm kill myproject:pr-123
  psm cleanup
EOF
}
