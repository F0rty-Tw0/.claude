---
name: kaizen
description: Use when improving code quality, refactoring, or discussing process improvements. Applies continuous improvement, error proofing, standardization, and just-in-time principles.
---
...
See [patterns-and-examples.md](patterns-and-examples.md) for detailed code examples and practical guidance.
...
See [patterns-and-examples.md](patterns-and-examples.md) for pattern-following examples, error handling patterns, and documentation standards.
