---
name: "source-command-review-claude"
description: "Migrated source command `review-Codex`"
---

# source-command-review-claude

Use this skill when the user asks to run the migrated source command `review-claude`.

## Command Template

Please review my current `agent.md` / `AGENTS.md` file and rewrite it following a strict, minimalist philosophy.
