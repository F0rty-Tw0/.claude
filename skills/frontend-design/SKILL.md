...
description: Use when building web components, pages, or applications that need distinctive, production-grade design quality and should avoid generic AI aesthetics.
---
...
Avoid these default patterns: overused font families (Inter, Roboto, Arial, system fonts), purple gradients on white backgrounds, cream or off-white page backgrounds, italic accent words in headlines, numbered "01/02/03" section labels, monospace eyebrow labels, and pill-shaped buttons. After a first pass, note which styles the result fell back on and add them to this list.
