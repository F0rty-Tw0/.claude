...
**Fix**: Configure the blob reporter for CI as shown in [Sharded Parallel Execution](#sharded-parallel-execution): `CI_REPORTER` holds `[['blob'], ['dot']]`, the local reporter stays `html`.
